...
define('HELLSPY_LOGIN_URL', 'http://www.hellspy.sk/dclient/auth/login');
define('HELLSPY_LOGOUT_URL', 'http://www.hellspy.sk/dclient/auth/logout');
define('HELLSPY_PING_URL', 'http://www.hellspy.sk/dclient/auth/ping');
define('HELLSPY_DETAIL_URL', 'http://www.hellspy.sk/dclient/info/getFileDetail');

class HellSpy
{
    protected $userAgent = 'HellSpy.sk - client v1.0.0';
    protected $cookieJar;
    ...
    public function parseUrl($url)
    {
        ...
        if ($url[2] != 'www.hellspy.sk') return false;

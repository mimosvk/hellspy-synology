...
define('HELLSPY_LOGIN_URL', 'http://www.hellspy.cz/dclient/auth/login');
define('HELLSPY_LOGOUT_URL', 'http://www.hellspy.cz/dclient/auth/logout');
define('HELLSPY_PING_URL', 'http://www.hellspy.cz/dclient/auth/ping');
define('HELLSPY_DETAIL_URL', 'http://www.hellspy.cz/dclient/info/getFileDetail');

class HellSpy
{
    protected $userAgent = 'HellSpy.cz - client v1.0.0';
    protected $cookieJar;
    ...
    public function parseUrl($url)
    {
        ...
        if ($url[2] != 'www.hellspy.cz') return false;
